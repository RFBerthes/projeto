  ...
  <div class="container  text-white mt-2 mb-2 pb-2">
    ...
    <div class="row">
      <?php while ($rowcm = $comandas->fetch()) {  
        if($rowcm['status_comanda'] != "Paga" && $rowcm['status_comanda'] != "Fechada" ) {
      ?>
        <div class="card text-dark mt-2 ml-3" style="width:20%">
          <a href="update/apagar-comanda.php?idcomanda=<?php echo $rowcm['idcomanda']; ?>"><button type="button" class="close float-rigth mr-2 mt-1"> <span aria-hidden="true">&times;</span></button></a>
