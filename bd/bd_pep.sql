...
--
-- Host: localhost
-- Tempo de geração: 27/05/2019 às 16:26
...
INSERT INTO `sabores` (`idsabor`, `nome`, `pizzas_idpizza`) VALUES
(1, 'Portuguesa', 0),
(2, 'Calabresa', 0),
(5, 'Frango', 0),
(9, 'Quatro Queijos', 0);
...
(9, 'atendente', 'Rafael Flores Berthes da Silva', 'atendente', 'atendente');
...
ALTER TABLE `sabores`
  ...
  ADD KEY `fk_sabores_pizzas1_idx` (`pizzas_idpizza`);
...
--
-- Restrições para tabelas `sabores`
--
ALTER TABLE `sabores`
  ADD CONSTRAINT `fk_sabores_pizzas1` FOREIGN KEY (`pizzas_idpizza`) REFERENCES `pizzas` (`idpizza`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
